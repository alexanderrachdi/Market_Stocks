...
/**
 * @extends ServiceEntityRepository<UserAlert>
 *
...
class UserAlertRepository extends ServiceEntityRepository
{
    ...
    public function add(UserAlert $entity, bool $flush = false): void
    {
    ...
    public function remove(UserAlert $entity, bool $flush = false): void
    {
